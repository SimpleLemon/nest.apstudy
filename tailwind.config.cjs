    ...
    theme: {
        extend: {
            colors: {
                ...
                card: withOpacity("--admin-panel"),
                "card-foreground": withOpacity("--admin-ink"),
                border: withOpacity("--admin-border"),
                "muted-foreground": withOpacity("--admin-muted"),
                foreground: withOpacity("--admin-ink"),
                muted: withOpacity("--admin-panel-strong"),
            },
            borderRadius: {
                DEFAULT: "0.25rem",
                lg: "0.5rem",
